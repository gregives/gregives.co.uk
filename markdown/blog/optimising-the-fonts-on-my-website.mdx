...
![Waterfall graph showing four fonts loading after 8 seconds](optimising-fonts/waterfall1.png)
...
>
  <source src="/videos/optimising-fonts/loading1.webm" type="video/webm" />
  <source src="/videos/optimising-fonts/loading1.mp4" type="video/mp4" />
</video>
...
![Details of DM Serif Text after uploading the font to Wakamai Fondue](optimising-fonts/wakamaifondue.png)
...
![Waterfall graph showing two fonts loading after 6 seconds and 8 seconds](optimising-fonts/waterfall2.png)
