...
- `html: true` allows me to put raw HTML into my Markdown files. This also allows me to put Vue components into my Markdown files, as explained in my previous blog post, [Build a Blog with Nuxt and Markdown](/blog/build-a-blog-with-nuxt-and-markdown).
...
- Add abbreviations
- Add <sup>superscript</sup> text
- Add <sub>subscript</sub> text
- Add <mark>marked</mark> text
- Add <ins>inserted</ins> text

```js showLineNumbers{28}
  .use(require('markdown-it-anchor'), {
    permalink: true,
    permalinkSymbol: '#',
    permalinkSpace: false
