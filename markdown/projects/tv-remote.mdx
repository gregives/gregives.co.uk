...
![Screenshot of the interface and final TV remote](tv-remote/interface.png)
...
![Graph showing the accuracy of the remote at varying range](tv-remote/testing.png)
