...
![Screenshots of Festimap app](festimap/screenshots1.png)
...
![Screenshots of Festimap app](festimap/screenshots2.png)
...
![Diagram showing the layout of the progressive web app's pages and data flow](festimap/diagram.png)
