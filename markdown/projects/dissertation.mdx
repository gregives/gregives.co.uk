...
I completed my dissertation as part of my 3<sup>rd</sup> year of university. Entitled "A Computer Vision System for a Chess-Playing Robot", my dissertation aimed to infer the state of a chessboard from a webcam placed above the board. You can [download the report here](/dissertation.pdf). Here's what the finished system looks like!

![Demonstration page of the system](dissertation/demonstration.png)
...
![Storyboard showing chess move e2e4](dissertation/e2e4.png)
...
![Canny edge detection on move e2e4](dissertation/canny.png)
...
![Annotation page of the system](dissertation/annotation.png)

![Testing page of the system](dissertation/testing.png)
...
To find out more, please [download the report here](/dissertation.pdf) or take a look at the repository.
