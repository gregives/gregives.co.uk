...
![Photo of the HackSheffield committee](hacksheffield/committee.jpg)
...
<iframe
  title="Greg's Hackathons – Google My Maps"
  src="https://www.google.com/maps/d/u/0/embed?mid=1TPa-VDk3oQ1qIfv2efqFSsRUzG5Zj2p0"
  width="640"
  height="480"
  loading="lazy"
  className="mt-4 w-full max-h-[60svh] drop-shadow-md"
/>
