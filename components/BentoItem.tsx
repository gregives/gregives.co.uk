...
export function BentoItem({
  ...
  return (
    <div
      className={twMerge(
        "relative flex flex-col justify-end rounded-3xl col-span-full px-4 sm:px-6 md:px-8 lg:px-10 py-6 md:py-8 bg-slate-300 dark:bg-slate-700 ring-1 ring-black/10 shadow shadow-black/20",
